      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <main id="main-content" className="flex-1 overflow-y-auto" tabIndex={-1}>
          <div
            ...
            className="page-enter py-4 pl-[max(1rem,env(safe-area-inset-left))] pr-[max(1rem,env(safe-area-inset-right))] lg:py-6 lg:pl-[max(1.5rem,env(safe-area-inset-left))] lg:pr-[max(1.5rem,env(safe-area-inset-right))] max-w-7xl mx-auto pb-20 lg:pb-6"
          >
            <Outlet />
          </div>
        </main>
